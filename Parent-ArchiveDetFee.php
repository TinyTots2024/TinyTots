...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['user_username'])) {
    ...
    if (isset($_GET["en_id"])) {
        ...
        $showDF = "SELECT * from archive_payment 
    ...
    <div class="white-box">
        ...
        <div class="main_content"> 
            <div class="info">
                    ...
                    <a href="Parent-ArchiveFees.php"><button class="allbutton">Back</button></a>
