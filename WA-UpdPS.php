    ...
    <div class="white-box">
        <body>
            <div class="main_content"> 
                <div class="info">
                <h2 class="head2">Update Preschool</h2>
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="button-container">
                            <button type="submit" name="delete" class="YesBTN">Submit</button>
                            <a href="WA-ChangeReq.php" class="NoBTN">Cancel</a>
                        </div>
                    </form>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group"><br>
                            <table class="DettblBorder">
                                ...
                                <tr>
                                    <td>Accreditation</td>
                                    <td><a href="../uploaded-image/<?php echo $preschoolRow['accreditation']; ?>" target="_blank">Open File</a></td>
                                </tr>
                                <tr>
                                    <td>Status</td>
                    ...
                    <a href='WA-PendingPSDetail.php?ps_id=<?php echo $ps_id; ?>'><button class="submitBTN">View Current Setup</button></a>            
