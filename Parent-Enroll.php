        ...
        <body>
            <div class="main_content"> 
                <div class="info">
                    ...
                    <?php else: ?>
                    <h2 class="header">Submitted Enrollment</h2>
                    <a href="Parent-ReEnroll.php"><button class="allbutton"><i class="fa-solid fa-plus" style="color: #ffffff;"></i> Re-enroll Student</button></a>
                    <a href="Parent-ArchiveEnroll.php"><button class="allbutton"><i class="fa-solid fa-inbox" style="color: #ffffff;"></i> Archive</button></a>

                    <form action="Parent-Search.php" method="GET">
